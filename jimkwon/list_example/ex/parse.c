...
int main()
{
	...
	down = line;
	printf("[%s]\n", down->arg);
	printf("[%s]\t", down->line->arg);
	printf("[%s]\t", down->line->next->arg);
	printf("[%s]\n", down->line->next->next->arg);
	printf("[%s]\t", down->line->line->arg);
	printf("[%s]\n", down->line->line->next->arg);
	printf("[%s]\t", down->line->next->line->arg);
	printf("[%s]\n", down->line->next->line->next->arg);
	printf("[%s]\t", down->line->next->next->line->arg);
	// while (down != NULL)
	// {
	// 	printf("level %d\n", lvl);
	// 	right = down;
